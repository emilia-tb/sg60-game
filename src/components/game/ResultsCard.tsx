...
export const ResultsCard: React.FC<ResultsCardProps> = ({
  ...
  useEffect(() => {
    ...
    const updatedLeaderboard = [...storedLeaderboard, newPlayer]
      .sort((a, b) => {
  ...
  const handleRating = (stars: number) => {
    ...
    if (playerParticulars) {
      ...
      // Update CSV data with rating
      const csvData = `${updatedParticulars.name},${updatedParticulars.phone},${updatedParticulars.email},${stars}`;
      console.log('Updated player data CSV:', csvData);
    }
  };
