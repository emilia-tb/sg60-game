      ...
      <Card className="w-full bg-white shadow-lg border-0 rounded-3xl p-4 md:p-8">
        <CardContent className="space-y-6 md:space-y-8">
          ...
          <div className="space-y-4 p-4 md:p-6 bg-blue-50 rounded-xl">
            ...
            <p className="sg-body text-center text-[10px]">*Online players are encouraged to give us a call at 6238 8832 before heading down to redeem your items at any of our clinics to ensure availability of gifts.</p>
          </div>
